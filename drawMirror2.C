...
void drawMirror2(int time_pos=5, int doSave=1, int move=1)
{
  ...
  int nTimePoints=40; // orig 20 then 5
  double tMin=0;
  double tH=(70-tMin)/(nTimePoints-1);
  

  int nMirrXPoints=5;
  double yMirrPos1=-3, yMirrPos2=3;
  ...
  double nBeamFullSize=70; // number of pixels for the beam
